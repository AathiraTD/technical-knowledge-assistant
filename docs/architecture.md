...
| **Change receiver** | Roadmap | Reads the sitemap's last-modified, falls back to conditional GET per page, enqueues changed URLs. The *trigger* is what is missing: the delta pipeline it would feed is built and proved |
